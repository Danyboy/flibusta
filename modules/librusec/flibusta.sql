...
CREATE TABLE IF NOT EXISTS libavtorname (
 ...
 CREATE TABLE IF NOT EXISTS libbook (
   ...
   Blocked char(1) NOT NULL,
   Modified timestamp NOT NULL default '2009-11-29 00:00:00',
   Source tinyint(1) unsigned NOT NULL default 0,
   State tinyint(1) unsigned NOT NULL default 0,
   SourceId int(11) unsigned NOT NULL default 0,
   PRIMARY KEY  (BookId),
...
CREATE TABLE IF NOT EXISTS libdonations (
  ...
  PayType char(10) NOT NULL default '' ,
  Time timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS libavtor_sync (
  BookId int(11) unsigned NOT NULL default 0,
  AvtorId int(11) unsigned NOT NULL default 0,
  Source tinyint(1) unsigned NOT NULL default 0,
  UNIQUE KEY u (Source,BookId,AvtorId),
  KEY iav (AvtorId)
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS libtranslator_sync (
  BookId int(11) unsigned NOT NULL default 0,
  TranslatorId int(11) unsigned NOT NULL default 0,
  Source tinyint(1) unsigned NOT NULL default 0,
  UNIQUE KEY u (Source,BookId,TranslatorId),
  KEY iav (TranslatorId)
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS libavtoraliase_sync (
  BadId int(11) NOT NULL default 0,
  GoodId int(11) NOT NULL default 0,
  Source tinyint(1) unsigned NOT NULL default 0,
  UNIQUE KEY u (Source,BadId),
  KEY GoodId (GoodId)
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS libavtorname_sync (
  AvtorId int(11) unsigned NOT NULL default 0,
  FirstName varchar(99) character set utf8 NOT NULL default '',
  MiddleName varchar(99) character set utf8 NOT NULL default '',
  LastName varchar(99) character set utf8 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS libgenre_sync (
  BookId int(11) unsigned NOT NULL default 0,
  GenreId int(11) unsigned NOT NULL default 0,
  Source tinyint(1) unsigned NOT NULL default 0,
  UNIQUE KEY u (Source,BookId,GenreId),
  KEY igenre (GenreId),
  KEY ibook (BookId)
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;

CREATE TABLE IF NOT EXISTS libjoinedbooks_sync (
  BadId int(11) unsigned NOT NULL default 0,
...
CREATE TABLE IF NOT EXISTS libsrclang_sync (
  BookId int(11) unsigned NOT NULL default 0,
  SrcLang char(2) NOT NULL default 0,
  Source tinyint(1) unsigned NOT NULL default 0,
  UNIQUE KEY u (Source,BookId),
  KEY SrcLang (SrcLang)
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS libblocked_sync (
  BookId int(11) unsigned NOT NULL default 0,
  uid int(11) NOT NULL,
  block char(1) NOT NULL default '0',
  Source tinyint(1) unsigned NOT NULL default 0,
  PRIMARY KEY u (Source,BookId)
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS libconflicts (
  ObjectType tinyint(1) unsigned NOT NULL default 0,
  FirstId int(11) unsigned NOT NULL default 0,
